...
public class JdbcIngredientRepository implements IngredientRepository {
	...
	/*
	 * // explicit RowMapper code for findOne method
	 * 
	 * @Override public Ingredient findOne(String id) { return
	 * jdbc.queryForObject("select id, name, type from Ingredient where id=?", new
